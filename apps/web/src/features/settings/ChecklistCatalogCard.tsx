...
interface ChecklistCatalogCardProps {
  ...
  createFn: (label: string) => Promise<ChecklistCatalogDto>;
 ...
 * SalesChannelsCard mais sans réordonnancement (jamais demandé pour ces
 * listes) : ajouter/renommer/désactiver-réactiver seulement.
 */
